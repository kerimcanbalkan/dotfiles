...
(use-package emacs
  ...
  (set-face-attribute 'default nil :family "JetBrainsMono Nerd Font"  :height 108)
...
;; Associate .jsx and .tsx with appropriate modes
...
(use-package evil
  ...
  (evil-define-key 'normal 'global (kbd "; b") 'consult-project-buffer) ;; Consult project buffer
  (evil-define-key 'normal 'global (kbd "<leader> p p") 'project-switch-project) ;; Switch project
  (evil-define-key 'normal 'global (kbd "; f") 'project-find-file) ;; Find file in project
  ...
  (evil-define-key 'normal 'global (kbd "<leader> s v") 'split-window-right)
